<template>
  <div>
    <div class="table-header">
      ...
      <hr>
      <el-button type="primary" size="mini" @click="toAdd" v-if="permission.indexOf('sys:college:add') >= 0">添加</el-button>
    </div>
    <el-table
      :data="page.list"
      border
        ...
        <template slot-scope="scope">
          <el-dropdown>
            ...
            <el-dropdown-menu slot="dropdown">
              <el-dropdown-item>
                <el-button size="mini" type="success" @click="toUpdate(scope.row.dictId)" v-if="permission.indexOf('sys:college:update') >= 0">编辑</el-button>
              </el-dropdown-item>
              <el-dropdown-item>
                <el-button size="mini" type="primary" @click="getMajor(scope.row.dictId)">查看专业</el-button>
              </el-dropdown-item>
              <el-dropdown-item>
                <el-button size="mini" type="danger" @click="toDelete(scope.row.dictId)" v-if="permission.indexOf('sys:college:delete') >= 0">删除</el-button>
              </el-dropdown-item>
            </el-dropdown-menu>
          </el-dropdown>
        </template>
