<template>
  <div>
    ...
    <!-- 题库列表开始 -->
    <el-row v-loading="this.$store.getters.loading">
      <el-col :span="6" v-for="bank in page.list" :key="bank.bankId" :offset="1">
        <el-card :body-style="{ padding: '0px' }" style="padding: 0px" shadow="hover" class="bank-card">
          <img :src="bank.bankImg" :alt="bank.bankName" class="image">
    ...
    <!-- 新增修改弹窗 -->
    <el-dialog :title="dialogTitle" :visible.sync="dialogFormVisible" v-loading="this.$store.getters.loading">
