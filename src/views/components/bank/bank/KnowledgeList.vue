<template>
  <div>
    ...
    <div class="table-header">
      ...
      <hr>
      <el-button type="primary" size="mini" @click="toAdd" v-if="permission.indexOf('know:add') >= 0">添加</el-button>
    </div>
    <!-- 搜索框结束 -->
    ...
    <el-row :gutter="20">
      <!-- 左边，卡片视图显示题库 -->
      <el-col :span="6">
        <div class="grid-content bg-purple" v-loading="this.$store.getters.loading">
      ...
      <el-col :span="18">
        <div class="grid-content bg-purple">
          <el-table :data="page.list" style="width: 100%" v-loading="this.$store.getters.loading">
              ...
              <template slot-scope="scope">
                <el-dropdown>
                  ...
                  <el-dropdown-menu slot="dropdown">
                    <el-dropdown-item>
                      <el-button size="mini" type="success" @click="toUpdate(scope.row.knowId)" v-if="permission.indexOf('know:update') >= 0">编辑</el-button>
                    </el-dropdown-item>
                    <el-dropdown-item>
                      <el-button type="primary" size="mini" @click="toType(scope.row.knowId)" v-if="permission.indexOf('know:type:list') >= 0">查看题型</el-button>
                    </el-dropdown-item>
                    <el-dropdown-item>
                      <el-button size="mini" type="danger" @click="deleteKnow(scope.row.knowId)" v-if="permission.indexOf('know:delete') >= 0">删除</el-button>
                    </el-dropdown-item>
                  </el-dropdown-menu>
                </el-dropdown>
              </template>
    ...
    <el-dialog title="查看题型" :visible.sync="dialogType">
      <el-form :inline="true" :model="page" class="demo-form-inline" size="mini" label-width="80px" v-loading="this.$store.getters.loading">
        ...
        <el-form-item>
          <el-button type="primary" @click="addBankType" size="mini" v-if="permission.indexOf('know:type:add') >= 0">添加</el-button>
        </el-form-item>
      </el-form>
      ...
      <el-table :data="bankTypeList" style="width: 100%">
        ...
        <el-table-column show-header="false" align="center">
          <template slot-scope="scope">
            <el-button size="mini" type="primary" @click="toQuestion(scope.row.bankId, scope.row.bankType)" v-if="permission.indexOf('question:list') >= 0">
              查看题目
            </el-button>
            <el-button size="mini" type="danger" @click="deleteBankType(scope.row.id)" v-if="permission.indexOf('know:type:delete') >= 0">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
    </el-dialog>
